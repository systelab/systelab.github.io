...
module.exports = ".allure-progress-bar {\n  width: 70%;\n  margin: 5px 0 0 20px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ReporterDialog = /** @class */ (function () {
    ...
    ReporterDialog.prototype.updateTestRunForTestCase = function (testSuite, testrun, userId, actualResults) {
        ...
        if (testSuite) {
            this.setTestRunStatus(testrun, testSuite, userId, actualResults)
                ...
                _this.testSuccess(testrun, _this.testSuiteService.getStatus(testSuite));
    ...
    ReporterDialog.prototype.testSuccess = function (testRun, status) {
        this.testsRunOk++;
